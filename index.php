            ...
            <div class="container mx-auto max-w-6xl px-4 py-16 md:py-20 grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                ...
                <div class="lg:pt-6">
                    <span class="eyebrow mb-5">
                        <i class="fas fa-shield-halved" aria-hidden="true"></i> Secure certificate tooling
                    </span>
                    ...
                    <div class="flex flex-wrap gap-3 mb-10">
                        <span class="trust-pill"><i class="fas fa-lock" aria-hidden="true"></i> Encrypted in transit</span>
                        <span class="trust-pill"><i class="fas fa-trash-can" aria-hidden="true"></i> Deleted instantly</span>
                        <span class="trust-pill"><i class="fas fa-eye-slash" aria-hidden="true"></i> Nothing logged</span>
                    </div>
                ...
                <div id="converter" class="card-elevated p-6 md:p-8 scroll-mt-24">
                    ...
                    <?php if (!empty($_SESSION['error'])): ?>
                        <div class="mb-6 rounded-lg border-base p-4 flex items-start gap-3"
                            ...
                            <i class="fas fa-circle-exclamation mt-0.5" style="color:#dc2626;" aria-hidden="true"></i>
                        ...
                        <div id="dropzone" class="p-6 rounded-xl text-center">
                            <label class="custom-file-input w-full flex flex-col items-center justify-center">
                                <span class="icon-tile w-12 h-12 mb-3">
                                    <i class="fas fa-file-arrow-up text-xl" aria-hidden="true"></i>
                                </span>
        ...
        <div class="container mx-auto max-w-6xl px-4">
            ...
            <section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                <div class="surface-card grow-on-hover p-6">
                    <span class="icon-tile w-12 h-12 mb-4"><i class="fas fa-shield-halved text-lg" aria-hidden="true"></i></span>
                ...
                <div class="surface-card grow-on-hover p-6">
                    <span class="icon-tile w-12 h-12 mb-4"><i class="fas fa-bolt text-lg" aria-hidden="true"></i></span>
                ...
                <div class="surface-card grow-on-hover p-6">
                    <span class="icon-tile w-12 h-12 mb-4"><i class="fas fa-server text-lg" aria-hidden="true"></i></span>
            ...
            <section id="features" class="mb-20 scroll-mt-24 cv-section">
                <div class="max-w-2xl mb-10">
                    <span class="eyebrow mb-3"><i class="fas fa-list-check" aria-hidden="true"></i> Features</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="surface-card grow-on-hover p-6 flex items-start gap-4">
                        <span class="icon-tile w-11 h-11 shrink-0"><i class="fas fa-lock" aria-hidden="true"></i></span>
                        <div>
                    ...
                    <div class="surface-card grow-on-hover p-6 flex items-start gap-4">
                        <span class="icon-tile w-11 h-11 shrink-0"><i class="fas fa-wand-magic-sparkles" aria-hidden="true"></i></span>
                        <div>
                    ...
                    <div class="surface-card grow-on-hover p-6 flex items-start gap-4">
                        <span class="icon-tile w-11 h-11 shrink-0"><i class="fas fa-certificate" aria-hidden="true"></i></span>
                        <div>
                    ...
                    <div class="surface-card grow-on-hover p-6 flex items-start gap-4">
                        <span class="icon-tile w-11 h-11 shrink-0"><i class="fas fa-file-zipper" aria-hidden="true"></i></span>
                        <div>
            ...
            <section id="how-it-works" class="mb-20 scroll-mt-24 cv-section">
                <div class="max-w-2xl mb-10">
                    <span class="eyebrow mb-3"><i class="fas fa-route" aria-hidden="true"></i> How it works</span>
                    <h2 class="text-3xl font-bold text-body">Three steps to your PEM files</h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="surface-card p-6">
                        <span class="icon-tile w-11 h-11 mb-4"><i class="fas fa-upload" aria-hidden="true"></i></span>
                    ...
                    <div class="surface-card p-6">
                        <span class="icon-tile w-11 h-11 mb-4"><i class="fas fa-key" aria-hidden="true"></i></span>
                    ...
                    <div class="surface-card p-6">
                        <span class="icon-tile w-11 h-11 mb-4"><i class="fas fa-download" aria-hidden="true"></i></span>
                ...
                <div class="surface-card p-6" style="background: var(--brand-soft); border-color: transparent;">
                    <div class="flex items-center gap-2.5 mb-4">
                        <i class="fas fa-lightbulb text-brand" aria-hidden="true"></i>
                        <h3 class="text-base font-semibold text-body">Pro tips</h3>
                    </div>
                    <ul class="space-y-2.5 text-sm text-muted">
                        <li class="flex items-start gap-2.5">
                            <i class="fas fa-circle-check mt-0.5" style="color: var(--success);" aria-hidden="true"></i>
            ...
            <section id="faq" class="mb-20 scroll-mt-24 cv-section">
                <div class="max-w-2xl mb-10">
                    <span class="eyebrow mb-3"><i class="fas fa-circle-question" aria-hidden="true"></i> FAQ</span>
                ...
                <div class="surface-card divide-base">
                    <div class="p-6">
                        <button class="faq-toggle flex justify-between items-center w-full text-left gap-4">
                            ...
                            <i class="fas fa-chevron-down text-faint transition-transform duration-300" aria-hidden="true"></i>
                        </button>
            ...
            <section class="mb-20 scroll-mt-24 cv-section">
                <div class="max-w-2xl mb-8">
                    <span class="eyebrow mb-3"><i class="fas fa-newspaper" aria-hidden="true"></i> Guides</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <a href="/blogs/extract-ssl-certificate-from-pfx/" class="surface-card grow-on-hover p-6 block">
                        <span class="icon-tile w-12 h-12 mb-4"><i class="fas fa-certificate text-lg" aria-hidden="true"></i></span>
                        ...
                        <span class="inline-flex items-center gap-2 text-brand font-medium text-sm">Read more <i class="fas fa-arrow-right" aria-hidden="true"></i></span>
                    </a>
                    <a href="/blogs/renew-ssl-certificate/" class="surface-card grow-on-hover p-6 block">
                        <span class="icon-tile w-12 h-12 mb-4"><i class="fas fa-rotate text-lg" aria-hidden="true"></i></span>
        ...
        <section class="gradient-bg scroll-mt-24">
            <div class="container mx-auto max-w-4xl px-4 py-16 text-center">
                ...
                <a href="#converter" class="inline-flex items-center gap-2 px-7 py-3.5 rounded-lg bg-white font-semibold shadow-lg" style="color: var(--brand-hover);">
                    <i class="fas fa-arrow-up" aria-hidden="true"></i> Convert now
                </a>
            </div>
        </section>
    </main>
